 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qc="FirebaseError";class He extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=qc,Object.setPrototypeOf(this,He.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Za.prototype.create)}}class Za{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},s=`${this.service}/${t}`,o=this.errors[t],a=o?jc(o,r):"Error",c=`${this.serviceName}: ${a} (${s}).`;return new He(s,c,r)}}function jc(n,t){return n.replace($c,(e,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const $c=/\{\$([^}]+)}/g;function pr(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const s of e){if(!r.includes(s))return!1;const o=n[s],a=t[s];if(Lo(o)&&Lo(a)){if(!pr(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!e.includes(s))return!1;return!0}function Lo(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hh="firebase-heartbeat-database",Kh=1,Tn="firebase-heartbeat-store";let gs=null;function su(){return gs||(gs=oh(Hh,Kh,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(Tn)}catch(e){console.warn(e)}}}}).catch(n=>{throw Zt.create("idb-open",{originalErrorMessage:n.message})})),gs}async function Qh(n){try{const e=(await su()).transaction(Tn),r=await e.objectStore(Tn).get(iu(n));return await e.done,r}catch(t){if(t instanceof He)Gt.warn(t.message);else{const e=Zt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Gt.warn(e.message)}}}async function $o(n,t){try{const r=(await su()).transaction(Tn,"readwrite");await r.objectStore(Tn).put(t,iu(n)),await r.done}catch(e){if(e instanceof He)Gt.warn(e.message);else{const r=Zt.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});Gt.warn(r.message)}}}function iu(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wh=1024,Yh=30;class Xh{constructor(t){this.container=t,this._heartbeatsCache=null;const e=this.container.getProvider("app").getImmediate();this._storage=new Zh(e),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var t,e;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=zo();if(((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(a=>a.date===o))return;if(this._heartbeatsCache.heartbeats.push({date:o,agent:s}),this._heartbeatsCache.heartbeats.length>Yh){const a=td(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){Gt.warn(r)}}async getHeartbeatsHeader(){var t;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=zo(),{heartbeatsToSend:r,unsentEntries:s}=Jh(this._heartbeatsCache.heartbeats),o=mr(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(e){return Gt.warn(e),""}}}function zo(){return new Date().toISOString().substring(0,10)}function Jh(n,t=Wh){const e=[];let r=n.slice();for(const s of n){const o=e.find(a=>a.agent===s.agent);if(o){if(o.dates.push(s.date),Go(e)>t){o.dates.pop();break}}else if(e.push({agent:s.agent,dates:[s.date]}),Go(e)>t){e.pop();break}r=r.slice(1)}return{heartbeatsToSend:e,unsentEntries:r}}class Zh{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Uc()?Bc().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const e=await Qh(this.app);return e!=null&&e.heartbeats?e:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){var e;if(await this._canUseIndexedDBPromise){const s=await this.read();return $o(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:s.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var e;if(await this._canUseIndexedDBPromise){const s=await this.read();return $o(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...t.heartbeats]})}else return}}function Go(n){return mr(JSON.stringify({version:2,heartbeats:n})).length}function td(n){if(n.length===0)return-1;let t=0,e=n[0].date;for(let r=1;r<n.length;r++)n[r].date<e&&(e=n[r].date,t=r);return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ed(n){_r(new vn("platform-logger",t=>new lh(t),"PRIVATE")),_r(new vn("heartbeat",t=>new Xh(t),"PRIVATE")),xe(As,qo,n),xe(As,qo,"esm2017"),xe("fire-js","")}ed("");var nd="firebase",rd="11.7.3";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */xe(nd,rd,"app");var Ho=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ye=new tu("@firebase/firestore");function De(){return ye.logLevel}function O(n,...t){if(ye.logLevel<=G.DEBUG){const e=t.map(Ks);ye.debug(`Firestore (${Ke}): ${n}`,...e)}}function Ht(n,...t){if(ye.logLevel<=G.ERROR){const e=t.map(Ks);ye.error(`Firestore (${Ke}): ${n}`,...e)}}function Fe(n,...t){if(ye.logLevel<=G.WARN){const e=t.map(Ks);ye.warn(`Firestore (${Ke}): ${n}`,...e)}}function Ks(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qe(n){if(n.code!==b.FAILED_PRECONDITION||n.message!==gd)throw n;O("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qs=-1;function Vr(n){return n==null}function yr(n){return n===0&&1/n==-1/0}function Ed(n){return typeof n=="number"&&Number.isInteger(n)&&!yr(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gu="";function vd(n){let t="";for(let e=0;e<n.length;e++)t.length>0&&(t=ta(t)),t=Td(n.get(e),t);return ta(t)}function Td(n,t){let e=t;const r=n.length;for(let s=0;s<r;s++){const o=n.charAt(s);switch(o){case"\0":e+="";break;case gu:e+="";break;default:e+=o}}return e}function ta(n){return n+gu+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ea(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function ve(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function _u(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mt{constructor(t){this.binaryString=t}static fromBase64String(t){const e=function(s){try{return atob(s)}catch(o){throw typeof DOMException<"u"&&o instanceof DOMException?new yu("Invalid base64 string: "+o):o}}(t);return new mt(e)}static fromUint8Array(t){const e=function(s){let o="";for(let a=0;a<s.length;++a)o+=String.fromCharCode(s[a]);return o}(t);return new mt(e)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(e){return btoa(e)}(this.binaryString)}toUint8Array(){return function(e){const r=new Uint8Array(e.length);for(let s=0;s<e.length;s++)r[s]=e.charCodeAt(s);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return q(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}mt.EMPTY_BYTE_STRING=new mt("");const Id=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function ie(n){if(K(!!n,39018),typeof n=="string"){let t=0;const e=Id.exec(n);if(K(!!e,46558,{timestamp:n}),e[1]){let s=e[1];s=(s+"000000000").substr(0,9),t=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:t}}return{seconds:rt(n.seconds),nanos:rt(n.nanos)}}function rt(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function oe(n){return typeof n=="string"?mt.fromBase64String(n):mt.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eu="server_timestamp",vu="__type__",Tu="__previous_value__",Iu="__local_write_time__";function Dr(n){var t,e;return((e=(((t=n==null?void 0:n.mapValue)===null||t===void 0?void 0:t.fields)||{})[vu])===null||e===void 0?void 0:e.stringValue)===Eu}function Nr(n){const t=n.mapValue.fields[Tu];return Dr(t)?Nr(t):t}function wn(n){const t=ie(n.mapValue.fields[Iu].timestampValue);return new ut(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bu{}class ot extends bu{constructor(t,e,r){super(),this.field=t,this.op=e,this.value=r}static create(t,e,r){return t.isKeyField()?e==="in"||e==="not-in"?this.createKeyFieldInFilter(t,e,r):new Sd(t,e,r):e==="array-contains"?new Nd(t,r):e==="in"?new kd(t,r):e==="not-in"?new Od(t,r):e==="array-contains-any"?new xd(t,r):new ot(t,e,r)}static createKeyFieldInFilter(t,e,r){return e==="in"?new Vd(t,r):new Dd(t,r)}matches(t){const e=t.data.field(this.field);return this.op==="!="?e!==null&&e.nullValue===void 0&&this.matchesComparison(Be(e,this.value)):e!==null&&ae(this.value)===ae(e)&&this.matchesComparison(Be(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return M(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class xt extends bu{constructor(t,e){super(),this.filters=t,this.op=e,this.Te=null}static create(t,e){return new xt(t,e)}matches(t){return Cu(this)?this.filters.find(e=>!e.matches(t))===void 0:this.filters.find(e=>e.matches(t))!==void 0}getFlattenedFilters(){return this.Te!==null||(this.Te=this.filters.reduce((t,e)=>t.concat(e.getFlattenedFilters()),[])),this.Te}getFilters(){return Object.assign([],this.filters)}}function Cu(n){return n.op==="and"}function Pu(n){return Pd(n)&&Cu(n)}function Pd(n){for(const t of n.filters)if(t instanceof xt)return!1;return!0}function Ds(n){if(n instanceof ot)return n.field.canonicalString()+n.op.toString()+qe(n.value);if(Pu(n))return n.filters.map(t=>Ds(t)).join(",");{const t=n.filters.map(e=>Ds(e)).join(",");return`${n.op}(${t})`}}function Su(n,t){return n instanceof ot?function(r,s){return s instanceof ot&&r.op===s.op&&r.field.isEqual(s.field)&&Ut(r.value,s.value)}(n,t):n instanceof xt?function(r,s){return s instanceof xt&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce((o,a,c)=>o&&Su(a,s.filters[c]),!0):!1}(n,t):void M(19439)}function Vu(n){return n instanceof ot?function(e){return`${e.field.canonicalString()} ${e.op} ${qe(e.value)}`}(n):n instanceof xt?function(e){return e.op.toString()+" {"+e.getFilters().map(Vu).join(" ,")+"}"}(n):"Filter"}class Sd extends ot{constructor(t,e,r){super(t,e,r),this.key=x.fromName(r.referenceValue)}matches(t){const e=x.comparator(t.key,this.key);return this.matchesComparison(e)}}class Vd extends ot{constructor(t,e){super(t,"in",e),this.keys=Du("in",e)}matches(t){return this.keys.some(e=>e.isEqual(t.key))}}class Dd extends ot{constructor(t,e){super(t,"not-in",e),this.keys=Du("not-in",e)}matches(t){return!this.keys.some(e=>e.isEqual(t.key))}}function Du(n,t){var e;return(((e=t.arrayValue)===null||e===void 0?void 0:e.values)||[]).map(r=>x.fromName(r.referenceValue))}class Nd extends ot{constructor(t,e){super(t,"array-contains",e)}matches(t){const e=t.data.field(this.field);return Ws(e)&&Rn(e.arrayValue,this.value)}}class kd extends ot{constructor(t,e){super(t,"in",e)}matches(t){const e=t.data.field(this.field);return e!==null&&Rn(this.value.arrayValue,e)}}class Od extends ot{constructor(t,e){super(t,"not-in",e)}matches(t){if(Rn(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return e!==null&&e.nullValue===void 0&&!Rn(this.value.arrayValue,e)}}class xd extends ot{constructor(t,e){super(t,"array-contains-any",e)}matches(t){const e=t.data.field(this.field);return!(!Ws(e)||!e.arrayValue.values)&&e.arrayValue.values.some(r=>Rn(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Md{constructor(t,e=null,r=[],s=[],o=null,a=null,c=null){this.path=t,this.collectionGroup=e,this.orderBy=r,this.filters=s,this.limit=o,this.startAt=a,this.endAt=c,this.Ie=null}}function la(n,t=null,e=[],r=[],s=null,o=null,a=null){return new Md(n,t,e,r,s,o,a)}function Ys(n){const t=F(n);if(t.Ie===null){let e=t.path.canonicalString();t.collectionGroup!==null&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map(r=>Ds(r)).join(","),e+="|ob:",e+=t.orderBy.map(r=>function(o){return o.field.canonicalString()+o.dir}(r)).join(","),Vr(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map(r=>qe(r)).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map(r=>qe(r)).join(",")),t.Ie=e}return t.Ie}function Xs(n,t){if(n.limit!==t.limit||n.orderBy.length!==t.orderBy.length)return!1;for(let e=0;e<n.orderBy.length;e++)if(!Cd(n.orderBy[e],t.orderBy[e]))return!1;if(n.filters.length!==t.filters.length)return!1;for(let e=0;e<n.filters.length;e++)if(!Su(n.filters[e],t.filters[e]))return!1;return n.collectionGroup===t.collectionGroup&&!!n.path.isEqual(t.path)&&!!ua(n.startAt,t.startAt)&&ua(n.endAt,t.endAt)}function Ns(n){return x.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qd=new tt(x.comparator);function Kt(){return qd}const Ou=new tt(x.comparator);function fn(...n){let t=Ou;for(const e of n)t=t.insert(e.key,e);return t}function xu(n){let t=Ou;return n.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function ge(){return yn()}function Mu(){return yn()}function yn(){return new Ie(n=>n.toString(),(n,t)=>n.isEqual(t))}const jd=new tt(x.comparator),$d=new lt(x.comparator);function j(...n){let t=$d;for(const e of n)t=t.add(e);return t}const zd=new lt(q);function Gd(){return zd}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ti(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:yr(t)?"-0":t}}function Lu(n){return{integerValue:""+n}}function Hd(n,t){return Ed(t)?Lu(t):ti(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xr{constructor(){this._=void 0}}function Kd(n,t,e){return n instanceof Cn?function(s,o){const a={fields:{[vu]:{stringValue:Eu},[Iu]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return o&&Dr(o)&&(o=Nr(o)),o&&(a.fields[Tu]=o),{mapValue:a}}(e,t):n instanceof Pn?Uu(n,t):n instanceof Sn?Bu(n,t):function(s,o){const a=Fu(s,o),c=ha(a)+ha(s.Re);return Vs(a)&&Vs(s.Re)?Lu(c):ti(s.serializer,c)}(n,t)}function Qd(n,t,e){return n instanceof Pn?Uu(n,t):n instanceof Sn?Bu(n,t):e}function Fu(n,t){return n instanceof wr?function(r){return Vs(r)||function(o){return!!o&&"doubleValue"in o}(r)}(t)?t:{integerValue:0}:null}class Cn extends xr{}class Pn extends xr{constructor(t){super(),this.elements=t}}function Uu(n,t){const e=qu(t);for(const r of n.elements)e.some(s=>Ut(s,r))||e.push(r);return{arrayValue:{values:e}}}class Sn extends xr{constructor(t){super(),this.elements=t}}function Bu(n,t){let e=qu(t);for(const r of n.elements)e=e.filter(s=>!Ut(s,r));return{arrayValue:{values:e}}}class wr extends xr{constructor(t,e){super(),this.serializer=t,this.Re=e}}function ha(n){return rt(n.integerValue||n.doubleValue)}function qu(n){return Ws(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const of=new te([4294967295,4294967295],0);function pa(n){const t=mu().encode(n),e=new ou;return e.update(t),new Uint8Array(e.digest())}function ga(n){const t=new DataView(n.buffer),e=t.getUint32(0,!0),r=t.getUint32(4,!0),s=t.getUint32(8,!0),o=t.getUint32(12,!0);return[new te([e,r],0),new te([s,o],0)]}class ni{constructor(t,e,r){if(this.bitmap=t,this.padding=e,this.hashCount=r,e<0||e>=8)throw new mn(`Invalid padding: ${e}`);if(r<0)throw new mn(`Invalid hash count: ${r}`);if(t.length>0&&this.hashCount===0)throw new mn(`Invalid hash count: ${r}`);if(t.length===0&&e!==0)throw new mn(`Invalid padding when bitmap length is 0: ${e}`);this.pe=8*t.length-e,this.ye=te.fromNumber(this.pe)}we(t,e,r){let s=t.add(e.multiply(te.fromNumber(r)));return s.compare(of)===1&&(s=new te([s.getBits(0),s.getBits(1)],0)),s.modulo(this.ye).toNumber()}be(t){return!!(this.bitmap[Math.floor(t/8)]&1<<t%8)}mightContain(t){if(this.pe===0)return!1;const e=pa(t),[r,s]=ga(e);for(let o=0;o<this.hashCount;o++){const a=this.we(r,s,o);if(!this.be(a))return!1}return!0}static create(t,e,r){const s=t%8==0?0:8-t%8,o=new Uint8Array(Math.ceil(t/8)),a=new ni(o,s,e);return r.forEach(c=>a.insert(c)),a}insert(t){if(this.pe===0)return;const e=pa(t),[r,s]=ga(e);for(let o=0;o<this.hashCount;o++){const a=this.we(r,s,o);this.Se(a)}}Se(t){const e=Math.floor(t/8),r=t%8;this.bitmap[e]|=1<<r}}class mn extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rf{constructor(t){this.wt=t}}function bf(n){const t=Ef({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Ir(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */bt.DEFAULT_COLLECTION_PERCENTILE=10,bt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,bt.DEFAULT=new bt(el,bt.DEFAULT_COLLECTION_PERCENTILE,bt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),bt.DISABLED=new bt(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Of{constructor(){this.changes=new Ie(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,Tt.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const r=this.changes.get(e);return r!==void 0?P.resolve(r):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lf{constructor(t){this.serializer=t,this.Fr=new Map,this.Mr=new Map}getBundleMetadata(t,e){return P.resolve(this.Fr.get(e))}saveBundleMetadata(t,e){return this.Fr.set(e.id,function(s){return{id:s.id,version:s.version,createTime:Ft(s.createTime)}}(e)),P.resolve()}getNamedQuery(t,e){return P.resolve(this.Mr.get(e))}saveNamedQuery(t,e){return this.Mr.set(e.name,function(s){return{name:s.name,query:bf(s.bundledQuery),readTime:Ft(s.readTime)}}(e)),P.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uf{constructor(){this.sessionToken=mt.EMPTY_BYTE_STRING}getSessionToken(t){return P.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,P.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qf{constructor(t){this.Zr=t,this.docs=function(){return new tt(x.comparator)}(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const r=e.key,s=this.docs.get(r),o=s?s.size:0,a=this.Zr(e);return this.docs=this.docs.insert(r,{document:e.mutableCopy(),size:a}),this.size+=a-o,this.indexManager.addToCollectionParentIndex(t,r.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const r=this.docs.get(e);return P.resolve(r?r.document.mutableCopy():Tt.newInvalidDocument(e))}getEntries(t,e){let r=Kt();return e.forEach(s=>{const o=this.docs.get(s);r=r.insert(s,o?o.document.mutableCopy():Tt.newInvalidDocument(s))}),P.resolve(r)}getDocumentsMatchingQuery(t,e,r,s){let o=Kt();const a=e.path,c=new x(a.child("__id-9223372036854775808__")),h=this.docs.getIteratorFrom(c);for(;h.hasNext();){const{key:f,value:{document:m}}=h.getNext();if(!a.isPrefixOf(f.path))break;f.path.length>a.length+1||pd(md(m),r)<=0||(s.has(m.key)||Or(e,m))&&(o=o.insert(m.key,m.mutableCopy()))}return P.resolve(o)}getAllFromCollectionGroup(t,e,r,s){M(9500)}Xr(t,e){return P.forEach(this.docs,r=>e(r))}newChangeBuffer(t){return new jf(this)}getSize(t){return P.resolve(this.size)}}class jf extends Of{constructor(t){super(),this.vr=t}applyChanges(t){const e=[];return this.changes.forEach((r,s)=>{s.isValidDocument()?e.push(this.vr.addEntry(t,s)):this.vr.removeEntry(r)}),P.waitFor(e)}getFromCache(t,e){return this.vr.getEntry(t,e)}getAllFromCache(t,e){return this.vr.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hf{constructor(){this.Ts=!1,this.Is=!1,this.Es=100,this.ds=function(){return Fc()?8:yd(Mc())>0?6:4}()}initialize(t,e){this.As=t,this.indexManager=e,this.Ts=!0}getDocumentsMatchingQuery(t,e,r,s){const o={result:null};return this.Rs(t,e).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Vs(t,e,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Gf;return this.fs(t,e,a).next(c=>{if(o.result=c,this.Is)return this.gs(t,e,a,c.size)})}).next(()=>o.result)}gs(t,e,r,s){return r.documentReadCount<this.Es?(De()<=G.DEBUG&&O("QueryEngine","SDK will not create cache indexes for query:",Ne(e),"since it only creates cache indexes for collection contains","more than or equal to",this.Es,"documents"),P.resolve()):(De()<=G.DEBUG&&O("QueryEngine","Query:",Ne(e),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.ds*s?(De()<=G.DEBUG&&O("QueryEngine","The SDK decides to create cache indexes for query:",Ne(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,Lt(e))):P.resolve())}Rs(t,e){if(ca(e))return P.resolve(null);let r=Lt(e);return this.indexManager.getIndexType(t,r).next(s=>s===0?null:(e.limit!==null&&s===1&&(e=Ir(e,null,"F"),r=Lt(e)),this.indexManager.getDocumentsMatchingTarget(t,r).next(o=>{const a=j(...o);return this.As.getDocuments(t,a).next(c=>this.indexManager.getMinOffset(t,r).next(h=>{const f=this.ps(e,c);return this.ys(e,f,a,h.readTime)?this.Rs(t,Ir(e,null,"F")):this.ws(t,f,e,h)}))})))}Vs(t,e,r,s){return ca(e)||s.isEqual(L.min())?P.resolve(null):this.As.getDocuments(t,r).next(o=>{const a=this.ps(e,o);return this.ys(e,a,r,s)?P.resolve(null):(De()<=G.DEBUG&&O("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Ne(e)),this.ws(t,a,e,fd(s,In)).next(c=>c))})}ps(t,e){let r=new lt(ku(t));return e.forEach((s,o)=>{Or(t,o)&&(r=r.add(o))}),r}ys(t,e,r,s){if(t.limit===null)return!1;if(r.size!==e.size)return!0;const o=t.limitType==="F"?e.last():e.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}fs(t,e,r){return De()<=G.DEBUG&&O("QueryEngine","Using full collection scan to execute query:",Ne(e)),this.As.getDocumentsMatchingQuery(t,e,se.min(),r)}ws(t,e,r,s){return this.As.getDocumentsMatchingQuery(t,r,s).next(o=>(e.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ys="RestConnection",sm={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class im{get Bo(){return!1}constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const e=t.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Lo=e+"://"+t.host,this.ko=`projects/${r}/databases/${s}`,this.qo=this.databaseId.database===Er?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Qo(t,e,r,s,o){const a=Us(),c=this.$o(t,e.toUriEncodedString());O(ys,`Sending RPC '${t}' ${a}:`,c,r);const h={"google-cloud-resource-prefix":this.ko,"x-goog-request-params":this.qo};this.Uo(h,s,o);const{host:f}=new URL(c),m=Gs(f);return this.Ko(t,c,h,r,m).then(y=>(O(ys,`Received RPC '${t}' ${a}: `,y),y),y=>{throw Fe(ys,`RPC '${t}' ${a} failed with error: `,y,"url: ",c,"request:",r),y})}Wo(t,e,r,s,o,a){return this.Qo(t,e,r,s,o)}Uo(t,e,r){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Ke}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach((s,o)=>t[o]=s),r&&r.headers.forEach((s,o)=>t[o]=s)}$o(t,e){const r=sm[t];return`${this.Lo}/v1/${e}:${r}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class om{constructor(t){this.Go=t.Go,this.zo=t.zo}jo(t){this.Ho=t}Jo(t){this.Yo=t}Zo(t){this.Xo=t}onMessage(t){this.e_=t}close(){this.zo()}send(t){this.Go(t)}t_(){this.Ho()}n_(){this.Yo()}r_(t){this.Xo(t)}i_(t){this.e_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Et="WebChannelConnection";class am extends im{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Ko(t,e,r,s,o){const a=Us();return new Promise((c,h)=>{const f=new au;f.setWithCredentials(!0),f.listenOnce(uu.COMPLETE,()=>{try{switch(f.getLastErrorCode()){case ur.NO_ERROR:const y=f.getResponseJson();O(Et,`XHR for RPC '${t}' ${a} received:`,JSON.stringify(y)),c(y);break;case ur.TIMEOUT:O(Et,`RPC '${t}' ${a} timed out`),h(new k(b.DEADLINE_EXCEEDED,"Request time out"));break;case ur.HTTP_ERROR:const I=f.getStatus();if(O(Et,`RPC '${t}' ${a} failed with status:`,I,"response text:",f.getResponseText()),I>0){let C=f.getResponseJson();Array.isArray(C)&&(C=C[0]);const V=C==null?void 0:C.error;if(V&&V.status&&V.message){const N=function(B){const U=B.toLowerCase().replace(/_/g,"-");return Object.values(b).indexOf(U)>=0?U:b.UNKNOWN}(V.status);h(new k(N,V.message))}else h(new k(b.UNKNOWN,"Server responded with status "+f.getStatus()))}else h(new k(b.UNAVAILABLE,"Connection failed."));break;default:M(9055,{s_:t,streamId:a,o_:f.getLastErrorCode(),__:f.getLastError()})}}finally{O(Et,`RPC '${t}' ${a} completed.`)}});const m=JSON.stringify(s);O(Et,`RPC '${t}' ${a} sending request:`,s),f.send(e,"POST",m,r,15)})}a_(t,e,r){const s=Us(),o=[this.Lo,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=hu(),c=cu(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},f=this.longPollingOptions.timeoutSeconds;f!==void 0&&(h.longPollingTimeout=Math.round(1e3*f)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Uo(h.initMessageHeaders,e,r),h.encodeInitMessageHeaders=!0;const m=o.join("");O(Et,`Creating RPC '${t}' stream ${s}: ${m}`,h);const y=a.createWebChannel(m,h);let I=!1,C=!1;const V=new om({Go:S=>{C?O(Et,`Not sending because RPC '${t}' stream ${s} is closed:`,S):(I||(O(Et,`Opening RPC '${t}' stream ${s} transport.`),y.open(),I=!0),O(Et,`RPC '${t}' stream ${s} sending:`,S),y.send(S))},zo:()=>y.close()}),N=(S,B,U)=>{S.listen(B,$=>{try{U($)}catch(X){setTimeout(()=>{throw X},0)}})};return N(y,dn.EventType.OPEN,()=>{C||(O(Et,`RPC '${t}' stream ${s} transport opened.`),V.t_())}),N(y,dn.EventType.CLOSE,()=>{C||(C=!0,O(Et,`RPC '${t}' stream ${s} transport closed`),V.r_())}),N(y,dn.EventType.ERROR,S=>{C||(C=!0,Fe(Et,`RPC '${t}' stream ${s} transport errored. Name:`,S.name,"Message:",S.message),V.r_(new k(b.UNAVAILABLE,"The operation could not be completed")))}),N(y,dn.EventType.MESSAGE,S=>{var B;if(!C){const U=S.data[0];K(!!U,16349);const $=U,X=($==null?void 0:$.error)||((B=$[0])===null||B===void 0?void 0:B.error);if(X){O(Et,`RPC '${t}' stream ${s} received error:`,X);const Ct=X.status;let J=function(g){const E=it[g];if(E!==void 0)return Gu(E)}(Ct),v=X.message;J===void 0&&(J=b.INTERNAL,v="Unknown error status: "+Ct+" with message "+X.message),C=!0,V.r_(new k(J,v)),y.close()}else O(Et,`RPC '${t}' stream ${s} received:`,U),V.i_(U)}}),N(c,lu.STAT_EVENT,S=>{S.stat===Cs.PROXY?O(Et,`RPC '${t}' stream ${s} detected buffering proxy`):S.stat===Cs.NOPROXY&&O(Et,`RPC '${t}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{V.n_()},0),V}}function Es(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fr(n){return new hf(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ca="PersistentStream";class ol{constructor(t,e,r,s,o,a,c,h){this.bi=t,this.R_=r,this.V_=s,this.connection=o,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=c,this.listener=h,this.state=0,this.m_=0,this.f_=null,this.g_=null,this.stream=null,this.p_=0,this.y_=new il(t,e)}w_(){return this.state===1||this.state===5||this.b_()}b_(){return this.state===2||this.state===3}start(){this.p_=0,this.state!==4?this.auth():this.S_()}async stop(){this.w_()&&await this.close(0)}D_(){this.state=0,this.y_.reset()}v_(){this.b_()&&this.f_===null&&(this.f_=this.bi.enqueueAfterDelay(this.R_,6e4,()=>this.C_()))}F_(t){this.M_(),this.stream.send(t)}async C_(){if(this.b_())return this.close(0)}M_(){this.f_&&(this.f_.cancel(),this.f_=null)}x_(){this.g_&&(this.g_.cancel(),this.g_=null)}async close(t,e){this.M_(),this.x_(),this.y_.cancel(),this.m_++,t!==4?this.y_.reset():e&&e.code===b.RESOURCE_EXHAUSTED?(Ht(e.toString()),Ht("Using maximum backoff delay to prevent overloading the backend."),this.y_.I_()):e&&e.code===b.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.O_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.Zo(e)}O_(){}auth(){this.state=1;const t=this.N_(this.m_),e=this.m_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([r,s])=>{this.m_===e&&this.B_(r,s)},r=>{t(()=>{const s=new k(b.UNKNOWN,"Fetching auth token failed: "+r.message);return this.L_(s)})})}B_(t,e){const r=this.N_(this.m_);this.stream=this.k_(t,e),this.stream.jo(()=>{r(()=>this.listener.jo())}),this.stream.Jo(()=>{r(()=>(this.state=2,this.g_=this.bi.enqueueAfterDelay(this.V_,1e4,()=>(this.b_()&&(this.state=3),Promise.resolve())),this.listener.Jo()))}),this.stream.Zo(s=>{r(()=>this.L_(s))}),this.stream.onMessage(s=>{r(()=>++this.p_==1?this.q_(s):this.onNext(s))})}S_(){this.state=5,this.y_.E_(async()=>{this.state=0,this.start()})}L_(t){return O(Ca,`close with error: ${t}`),this.stream=null,this.close(4,t)}N_(t){return e=>{this.bi.enqueueAndForget(()=>this.m_===t?e():(O(Ca,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class um extends ol{constructor(t,e,r,s,o,a){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,r,s,a),this.serializer=o}k_(t,e){return this.connection.a_("Listen",t,e)}q_(t){return this.onNext(t)}onNext(t){this.y_.reset();const e=mf(this.serializer,t),r=function(o){if(!("targetChange"in o))return L.min();const a=o.targetChange;return a.targetIds&&a.targetIds.length?L.min():a.readTime?Ft(a.readTime):L.min()}(t);return this.listener.Q_(e,r)}U_(t){const e={};e.database=Ls(this.serializer),e.addTarget=function(o,a){let c;const h=a.target;if(c=Ns(h)?{documents:_f(o,h)}:{query:yf(o,h).gt},c.targetId=a.targetId,a.resumeToken.approximateByteSize()>0){c.resumeToken=Qu(o,a.resumeToken);const f=Os(o,a.expectedCount);f!==null&&(c.expectedCount=f)}else if(a.snapshotVersion.compareTo(L.min())>0){c.readTime=Ar(o,a.snapshotVersion.toTimestamp());const f=Os(o,a.expectedCount);f!==null&&(c.expectedCount=f)}return c}(this.serializer,t);const r=vf(this.serializer,t);r&&(e.labels=r),this.F_(e)}K_(t){const e={};e.database=Ls(this.serializer),e.removeTarget=t,this.F_(e)}}class lm extends ol{constructor(t,e,r,s,o,a){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,r,s,a),this.serializer=o}get W_(){return this.p_>0}start(){this.lastStreamToken=void 0,super.start()}O_(){this.W_&&this.G_([])}k_(t,e){return this.connection.a_("Write",t,e)}q_(t){return K(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,K(!t.writeResults||t.writeResults.length===0,55816),this.listener.z_()}onNext(t){K(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.y_.reset();const e=gf(t.writeResults,t.commitTime),r=Ft(t.commitTime);return this.listener.j_(r,e)}H_(){const t={};t.database=Ls(this.serializer),this.F_(t)}G_(t){const e={streamToken:this.lastStreamToken,writes:t.map(r=>pf(this.serializer,r))};this.F_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ee="RemoteStore";class fm{constructor(t,e,r,s,o){this.localStore=t,this.datastore=e,this.asyncQueue=r,this.remoteSyncer={},this.oa=[],this._a=new Map,this.aa=new Set,this.ua=[],this.ca=o,this.ca.vo(a=>{r.enqueueAndForget(async()=>{Ae(this)&&(O(Ee,"Restarting streams for network reachability change."),await async function(h){const f=F(h);f.aa.add(4),await kn(f),f.la.set("Unknown"),f.aa.delete(4),await Ur(f)}(this))})}),this.la=new dm(r,s)}}async function Ur(n){if(Ae(n))for(const t of n.ua)await t(!0)}async function kn(n){for(const t of n.ua)await t(!1)}function al(n,t){const e=F(n);e._a.has(t.targetId)||(e._a.set(t.targetId,t),hi(e)?ci(e):Ye(e).b_()&&li(e,t))}function ui(n,t){const e=F(n),r=Ye(e);e._a.delete(t),r.b_()&&ul(e,t),e._a.size===0&&(r.b_()?r.v_():Ae(e)&&e.la.set("Unknown"))}function li(n,t){if(n.ha.Ke(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(L.min())>0){const e=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}Ye(n).U_(t)}function ul(n,t){n.ha.Ke(t),Ye(n).K_(t)}function ci(n){n.ha=new af({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),Rt:t=>n._a.get(t)||null,Pt:()=>n.datastore.serializer.databaseId}),Ye(n).start(),n.la.ta()}function hi(n){return Ae(n)&&!Ye(n).w_()&&n._a.size>0}function Ae(n){return F(n).aa.size===0}function ll(n){n.ha=void 0}async function mm(n){n.la.set("Online")}async function pm(n){n._a.forEach((t,e)=>{li(n,t)})}async function gm(n,t){ll(n),hi(n)?(n.la.ia(t),ci(n)):n.la.set("Unknown")}async function _m(n,t,e){if(n.la.set("Online"),t instanceof Ku&&t.state===2&&t.cause)try{await async function(s,o){const a=o.cause;for(const c of o.targetIds)s._a.has(c)&&(await s.remoteSyncer.rejectListen(c,a),s._a.delete(c),s.ha.removeTarget(c))}(n,t)}catch(r){O(Ee,"Failed to remove targets %s: %s ",t.targetIds.join(","),r),await br(n,r)}else if(t instanceof dr?n.ha.Xe(t):t instanceof Hu?n.ha.ot(t):n.ha.nt(t),!e.isEqual(L.min()))try{const r=await sl(n.localStore);e.compareTo(r)>=0&&await function(o,a){const c=o.ha.It(a);return c.targetChanges.forEach((h,f)=>{if(h.resumeToken.approximateByteSize()>0){const m=o._a.get(f);m&&o._a.set(f,m.withResumeToken(h.resumeToken,a))}}),c.targetMismatches.forEach((h,f)=>{const m=o._a.get(h);if(!m)return;o._a.set(h,m.withResumeToken(mt.EMPTY_BYTE_STRING,m.snapshotVersion)),ul(o,h);const y=new Xt(m.target,h,f,m.sequenceNumber);li(o,y)}),o.remoteSyncer.applyRemoteEvent(c)}(n,e)}catch(r){O(Ee,"Failed to raise snapshot:",r),await br(n,r)}}async function br(n,t,e){if(!We(t))throw t;n.aa.add(1),await kn(n),n.la.set("Offline"),e||(e=()=>sl(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{O(Ee,"Retrying IndexedDB access"),await e(),n.aa.delete(1),await Ur(n)})}function cl(n,t){return t().catch(e=>br(n,e,t))}async function Br(n){const t=F(n),e=ue(t);let r=t.oa.length>0?t.oa[t.oa.length-1].batchId:Qs;for(;ym(t);)try{const s=await Zf(t.localStore,r);if(s===null){t.oa.length===0&&e.v_();break}r=s.batchId,Em(t,s)}catch(s){await br(t,s)}hl(t)&&dl(t)}function ym(n){return Ae(n)&&n.oa.length<10}function Em(n,t){n.oa.push(t);const e=ue(n);e.b_()&&e.W_&&e.G_(t.mutations)}function hl(n){return Ae(n)&&!ue(n).w_()&&n.oa.length>0}function dl(n){ue(n).start()}async function vm(n){ue(n).H_()}async function Tm(n){const t=ue(n);for(const e of n.oa)t.G_(e.mutations)}async function Im(n,t,e){const r=n.oa.shift(),s=ei.from(r,t,e);await cl(n,()=>n.remoteSyncer.applySuccessfulWrite(s)),await Br(n)}async function wm(n,t){t&&ue(n).W_&&await async function(r,s){if(function(a){return sf(a)&&a!==b.ABORTED}(s.code)){const o=r.oa.shift();ue(r).D_(),await cl(r,()=>r.remoteSyncer.rejectFailedWrite(o.batchId,s)),await Br(r)}}(n,t),hl(n)&&dl(n)}async function Pa(n,t){const e=F(n);e.asyncQueue.verifyOperationInProgress(),O(Ee,"RemoteStore received new credentials");const r=Ae(e);e.aa.add(3),await kn(e),r&&e.la.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.aa.delete(3),await Ur(e)}async function Am(n,t){const e=F(n);t?(e.aa.delete(2),await Ur(e)):t||(e.aa.add(2),await kn(e),e.la.set("Unknown"))}function Ye(n){return n.Pa||(n.Pa=function(e,r,s){const o=F(e);return o.Y_(),new um(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)}(n.datastore,n.asyncQueue,{jo:mm.bind(null,n),Jo:pm.bind(null,n),Zo:gm.bind(null,n),Q_:_m.bind(null,n)}),n.ua.push(async t=>{t?(n.Pa.D_(),hi(n)?ci(n):n.la.set("Unknown")):(await n.Pa.stop(),ll(n))})),n.Pa}function ue(n){return n.Ta||(n.Ta=function(e,r,s){const o=F(e);return o.Y_(),new lm(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)}(n.datastore,n.asyncQueue,{jo:()=>Promise.resolve(),Jo:vm.bind(null,n),Zo:wm.bind(null,n),z_:Tm.bind(null,n),j_:Im.bind(null,n)}),n.ua.push(async t=>{t?(n.Ta.D_(),await Br(n)):(await n.Ta.stop(),n.oa.length>0&&(O(Ee,`Stopping write stream with ${n.oa.length} pending writes`),n.oa=[]))})),n.Ta}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Le{static emptySet(t){return new Le(t.comparator)}constructor(t){this.comparator=t?(e,r)=>t(e,r)||x.comparator(e.key,r.key):(e,r)=>x.comparator(e.key,r.key),this.keyedMap=fn(),this.sortedSet=new tt(this.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const e=this.keyedMap.get(t);return e?this.sortedSet.indexOf(e):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((e,r)=>(t(e),!1))}add(t){const e=this.delete(t.key);return e.copy(e.keyedMap.insert(t.key,t),e.sortedSet.insert(t,null))}delete(t){const e=this.get(t);return e?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(e)):this}isEqual(t){if(!(t instanceof Le)||this.size!==t.size)return!1;const e=this.sortedSet.getIterator(),r=t.sortedSet.getIterator();for(;e.hasNext();){const s=e.getNext().key,o=r.getNext().key;if(!s.isEqual(o))return!1}return!0}toString(){const t=[];return this.forEach(e=>{t.push(e.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sa{constructor(){this.Ia=new tt(x.comparator)}track(t){const e=t.doc.key,r=this.Ia.get(e);r?t.type!==0&&r.type===3?this.Ia=this.Ia.insert(e,t):t.type===3&&r.type!==1?this.Ia=this.Ia.insert(e,{type:r.type,doc:t.doc}):t.type===2&&r.type===2?this.Ia=this.Ia.insert(e,{type:2,doc:t.doc}):t.type===2&&r.type===0?this.Ia=this.Ia.insert(e,{type:0,doc:t.doc}):t.type===1&&r.type===0?this.Ia=this.Ia.remove(e):t.type===1&&r.type===2?this.Ia=this.Ia.insert(e,{type:1,doc:r.doc}):t.type===0&&r.type===1?this.Ia=this.Ia.insert(e,{type:2,doc:t.doc}):M(63341,{Vt:t,Ea:r}):this.Ia=this.Ia.insert(e,t)}da(){const t=[];return this.Ia.inorderTraversal((e,r)=>{t.push(r)}),t}}class ze{constructor(t,e,r,s,o,a,c,h,f){this.query=t,this.docs=e,this.oldDocs=r,this.docChanges=s,this.mutatedKeys=o,this.fromCache=a,this.syncStateChanged=c,this.excludesMetadataChanges=h,this.hasCachedResults=f}static fromInitialDocuments(t,e,r,s,o){const a=[];return e.forEach(c=>{a.push({type:0,doc:c})}),new ze(t,e,Le.emptySet(e),a,r,s,!0,!1,o)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(t){if(!(this.fromCache===t.fromCache&&this.hasCachedResults===t.hasCachedResults&&this.syncStateChanged===t.syncStateChanged&&this.mutatedKeys.isEqual(t.mutatedKeys)&&kr(this.query,t.query)&&this.docs.isEqual(t.docs)&&this.oldDocs.isEqual(t.oldDocs)))return!1;const e=this.docChanges,r=t.docChanges;if(e.length!==r.length)return!1;for(let s=0;s<e.length;s++)if(e[s].type!==r[s].type||!e[s].doc.isEqual(r[s].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gl{constructor(t){this.key=t}}class _l{constructor(t){this.key=t}}class Sm{constructor(t,e){this.query=t,this.qa=e,this.Qa=null,this.hasCachedResults=!1,this.current=!1,this.$a=j(),this.mutatedKeys=j(),this.Ua=ku(t),this.Ka=new Le(this.Ua)}get Wa(){return this.qa}Ga(t,e){const r=e?e.za:new Sa,s=e?e.Ka:this.Ka;let o=e?e.mutatedKeys:this.mutatedKeys,a=s,c=!1;const h=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,f=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(t.inorderTraversal((m,y)=>{const I=s.get(m),C=Or(this.query,y)?y:null,V=!!I&&this.mutatedKeys.has(I.key),N=!!C&&(C.hasLocalMutations||this.mutatedKeys.has(C.key)&&C.hasCommittedMutations);let S=!1;I&&C?I.data.isEqual(C.data)?V!==N&&(r.track({type:3,doc:C}),S=!0):this.ja(I,C)||(r.track({type:2,doc:C}),S=!0,(h&&this.Ua(C,h)>0||f&&this.Ua(C,f)<0)&&(c=!0)):!I&&C?(r.track({type:0,doc:C}),S=!0):I&&!C&&(r.track({type:1,doc:I}),S=!0,(h||f)&&(c=!0)),S&&(C?(a=a.add(C),o=N?o.add(m):o.delete(m)):(a=a.delete(m),o=o.delete(m)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const m=this.query.limitType==="F"?a.last():a.first();a=a.delete(m.key),o=o.delete(m.key),r.track({type:1,doc:m})}return{Ka:a,za:r,ys:c,mutatedKeys:o}}ja(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,r,s){const o=this.Ka;this.Ka=t.Ka,this.mutatedKeys=t.mutatedKeys;const a=t.za.da();a.sort((m,y)=>function(C,V){const N=S=>{switch(S){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return M(20277,{Vt:S})}};return N(C)-N(V)}(m.type,y.type)||this.Ua(m.doc,y.doc)),this.Ha(r),s=s!=null&&s;const c=e&&!s?this.Ja():[],h=this.$a.size===0&&this.current&&!s?1:0,f=h!==this.Qa;return this.Qa=h,a.length!==0||f?{snapshot:new ze(this.query,t.Ka,o,a,t.mutatedKeys,h===0,f,!1,!!r&&r.resumeToken.approximateByteSize()>0),Ya:c}:{Ya:c}}ga(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({Ka:this.Ka,za:new Sa,mutatedKeys:this.mutatedKeys,ys:!1},!1)):{Ya:[]}}Za(t){return!this.qa.has(t)&&!!this.Ka.has(t)&&!this.Ka.get(t).hasLocalMutations}Ha(t){t&&(t.addedDocuments.forEach(e=>this.qa=this.qa.add(e)),t.modifiedDocuments.forEach(e=>{}),t.removedDocuments.forEach(e=>this.qa=this.qa.delete(e)),this.current=t.current)}Ja(){if(!this.current)return[];const t=this.$a;this.$a=j(),this.Ka.forEach(r=>{this.Za(r.key)&&(this.$a=this.$a.add(r.key))});const e=[];return t.forEach(r=>{this.$a.has(r)||e.push(new _l(r))}),this.$a.forEach(r=>{t.has(r)||e.push(new gl(r))}),e}Xa(t){this.qa=t.Ns,this.$a=j();const e=this.Ga(t.documents);return this.applyChanges(e,!0)}eu(){return ze.fromInitialDocuments(this.query,this.Ka,this.mutatedKeys,this.Qa===0,this.hasCachedResults)}}const pi="SyncEngine";class Vm{constructor(t,e,r){this.query=t,this.targetId=e,this.view=r}}class Dm{constructor(t){this.key=t,this.tu=!1}}class Nm{constructor(t,e,r,s,o,a){this.localStore=t,this.remoteStore=e,this.eventManager=r,this.sharedClientState=s,this.currentUser=o,this.maxConcurrentLimboResolutions=a,this.nu={},this.ru=new Ie(c=>Nu(c),kr),this.iu=new Map,this.su=new Set,this.ou=new tt(x.comparator),this._u=new Map,this.au=new si,this.uu={},this.cu=new Map,this.lu=$e.ir(),this.onlineState="Unknown",this.hu=void 0}get isPrimaryClient(){return this.hu===!0}}async function km(n,t,e=!0){const r=wl(n);let s;const o=r.ru.get(t);return o?(r.sharedClientState.addLocalQueryTarget(o.targetId),s=o.view.eu()):s=await yl(r,t,e,!0),s}async function Om(n,t){const e=wl(n);await yl(e,t,!0,!1)}async function yl(n,t,e,r){const s=await tm(n.localStore,Lt(t)),o=s.targetId,a=n.sharedClientState.addLocalQueryTarget(o,e);let c;return r&&(c=await xm(n,t,o,a==="current",s.resumeToken)),n.isPrimaryClient&&e&&al(n.remoteStore,s),c}async function xm(n,t,e,r,s){n.Pu=(y,I,C)=>async function(N,S,B,U){let $=S.view.Ga(B);$.ys&&($=await wa(N.localStore,S.query,!1).then(({documents:v})=>S.view.Ga(v,$)));const X=U&&U.targetChanges.get(S.targetId),Ct=U&&U.targetMismatches.get(S.targetId)!=null,J=S.view.applyChanges($,N.isPrimaryClient,X,Ct);return ka(N,S.targetId,J.Ya),J.snapshot}(n,y,I,C);const o=await wa(n.localStore,t,!0),a=new Sm(t,o.Ns),c=a.Ga(o.documents),h=Nn.createSynthesizedTargetChangeForCurrentChange(e,r&&n.onlineState!=="Offline",s),f=a.applyChanges(c,n.isPrimaryClient,h);ka(n,e,f.Ya);const m=new Vm(t,e,a);return n.ru.set(t,m),n.iu.has(e)?n.iu.get(e).push(t):n.iu.set(e,[t]),f.snapshot}async function Mm(n,t,e){const r=F(n),s=r.ru.get(t),o=r.iu.get(s.targetId);if(o.length>1)return r.iu.set(s.targetId,o.filter(a=>!kr(a,t))),void r.ru.delete(t);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await Fs(r.localStore,s.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(s.targetId),e&&ui(r.remoteStore,s.targetId),qs(r,s.targetId)}).catch(Qe)):(qs(r,s.targetId),await Fs(r.localStore,s.targetId,!0))}async function Lm(n,t){const e=F(n),r=e.ru.get(t),s=e.iu.get(r.targetId);e.isPrimaryClient&&s.length===1&&(e.sharedClientState.removeLocalQueryTarget(r.targetId),ui(e.remoteStore,r.targetId))}async function Fm(n,t,e){const r=Gm(n);try{const s=await function(a,c){const h=F(a),f=ut.now(),m=c.reduce((C,V)=>C.add(V.key),j());let y,I;return h.persistence.runTransaction("Locally write mutations","readwrite",C=>{let V=Kt(),N=j();return h.Cs.getEntries(C,m).next(S=>{V=S,V.forEach((B,U)=>{U.isValidDocument()||(N=N.add(B))})}).next(()=>h.localDocuments.getOverlayedDocuments(C,V)).next(S=>{y=S;const B=[];for(const U of c){const $=Zd(U,y.get(U.key).overlayedDocument);$!=null&&B.push(new we(U.key,$,Ru($.value.mapValue),zt.exists(!0)))}return h.mutationQueue.addMutationBatch(C,f,B,c)}).next(S=>{I=S;const B=S.applyToLocalDocumentSet(y,N);return h.documentOverlayCache.saveOverlays(C,S.batchId,B)})}).then(()=>({batchId:I.batchId,changes:xu(y)}))}(r.localStore,t);r.sharedClientState.addPendingMutation(s.batchId),function(a,c,h){let f=a.uu[a.currentUser.toKey()];f||(f=new tt(q)),f=f.insert(c,h),a.uu[a.currentUser.toKey()]=f}(r,s.batchId,e),await On(r,s.changes),await Br(r.remoteStore)}catch(s){const o=fi(s,"Failed to persist write");e.reject(o)}}async function El(n,t){const e=F(n);try{const r=await Xf(e.localStore,t);t.targetChanges.forEach((s,o)=>{const a=e._u.get(o);a&&(K(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1,22616),s.addedDocuments.size>0?a.tu=!0:s.modifiedDocuments.size>0?K(a.tu,14607):s.removedDocuments.size>0&&(K(a.tu,42227),a.tu=!1))}),await On(e,r,t)}catch(r){await Qe(r)}}function Na(n,t,e){const r=F(n);if(r.isPrimaryClient&&e===0||!r.isPrimaryClient&&e===1){const s=[];r.ru.forEach((o,a)=>{const c=a.view.ga(t);c.snapshot&&s.push(c.snapshot)}),function(a,c){const h=F(a);h.onlineState=c;let f=!1;h.queries.forEach((m,y)=>{for(const I of y.Ra)I.ga(c)&&(f=!0)}),f&&mi(h)}(r.eventManager,t),s.length&&r.nu.Q_(s),r.onlineState=t,r.isPrimaryClient&&r.sharedClientState.setOnlineState(t)}}async function Um(n,t,e){const r=F(n);r.sharedClientState.updateQueryState(t,"rejected",e);const s=r._u.get(t),o=s&&s.key;if(o){let a=new tt(x.comparator);a=a.insert(o,Tt.newNoDocument(o,L.min()));const c=j().add(o),h=new Lr(L.min(),new Map,new tt(q),a,c);await El(r,h),r.ou=r.ou.remove(o),r._u.delete(t),gi(r)}else await Fs(r.localStore,t,!1).then(()=>qs(r,t,e)).catch(Qe)}async function Bm(n,t){const e=F(n),r=t.batch.batchId;try{const s=await Yf(e.localStore,t);Tl(e,r,null),vl(e,r),e.sharedClientState.updateMutationState(r,"acknowledged"),await On(e,s)}catch(s){await Qe(s)}}async function qm(n,t,e){const r=F(n);try{const s=await function(a,c){const h=F(a);return h.persistence.runTransaction("Reject batch","readwrite-primary",f=>{let m;return h.mutationQueue.lookupMutationBatch(f,c).next(y=>(K(y!==null,37113),m=y.keys(),h.mutationQueue.removeMutationBatch(f,y))).next(()=>h.mutationQueue.performConsistencyCheck(f)).next(()=>h.documentOverlayCache.removeOverlaysForBatchId(f,m,c)).next(()=>h.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(f,m)).next(()=>h.localDocuments.getDocuments(f,m))})}(r.localStore,t);Tl(r,t,e),vl(r,t),r.sharedClientState.updateMutationState(t,"rejected",e),await On(r,s)}catch(s){await Qe(s)}}function vl(n,t){(n.cu.get(t)||[]).forEach(e=>{e.resolve()}),n.cu.delete(t)}function Tl(n,t,e){const r=F(n);let s=r.uu[r.currentUser.toKey()];if(s){const o=s.get(t);o&&(e?o.reject(e):o.resolve(),s=s.remove(t)),r.uu[r.currentUser.toKey()]=s}}function qs(n,t,e=null){n.sharedClientState.removeLocalQueryTarget(t);for(const r of n.iu.get(t))n.ru.delete(r),e&&n.nu.Tu(r,e);n.iu.delete(t),n.isPrimaryClient&&n.au.Ur(t).forEach(r=>{n.au.containsKey(r)||Il(n,r)})}function Il(n,t){n.su.delete(t.path.canonicalString());const e=n.ou.get(t);e!==null&&(ui(n.remoteStore,e),n.ou=n.ou.remove(t),n._u.delete(e),gi(n))}function ka(n,t,e){for(const r of e)r instanceof gl?(n.au.addReference(r.key,t),jm(n,r)):r instanceof _l?(O(pi,"Document no longer in limbo: "+r.key),n.au.removeReference(r.key,t),n.au.containsKey(r.key)||Il(n,r.key)):M(19791,{Iu:r})}function jm(n,t){const e=t.key,r=e.path.canonicalString();n.ou.get(e)||n.su.has(r)||(O(pi,"New document in limbo: "+e),n.su.add(r),gi(n))}function gi(n){for(;n.su.size>0&&n.ou.size<n.maxConcurrentLimboResolutions;){const t=n.su.values().next().value;n.su.delete(t);const e=new x(W.fromString(t)),r=n.lu.next();n._u.set(r,new Dm(e)),n.ou=n.ou.insert(e,r),al(n.remoteStore,new Xt(Lt(Js(e.path)),r,"TargetPurposeLimboResolution",Sr.le))}}async function On(n,t,e){const r=F(n),s=[],o=[],a=[];r.ru.isEmpty()||(r.ru.forEach((c,h)=>{a.push(r.Pu(h,t,e).then(f=>{var m;if((f||e)&&r.isPrimaryClient){const y=f?!f.fromCache:(m=e==null?void 0:e.targetChanges.get(h.targetId))===null||m===void 0?void 0:m.current;r.sharedClientState.updateQueryState(h.targetId,y?"current":"not-current")}if(f){s.push(f);const y=oi.Ps(h.targetId,f);o.push(y)}}))}),await Promise.all(a),r.nu.Q_(s),await async function(h,f){const m=F(h);try{await m.persistence.runTransaction("notifyLocalViewChanges","readwrite",y=>P.forEach(f,I=>P.forEach(I.ls,C=>m.persistence.referenceDelegate.addReference(y,I.targetId,C)).next(()=>P.forEach(I.hs,C=>m.persistence.referenceDelegate.removeReference(y,I.targetId,C)))))}catch(y){if(!We(y))throw y;O(ai,"Failed to update sequence numbers: "+y)}for(const y of f){const I=y.targetId;if(!y.fromCache){const C=m.Ss.get(I),V=C.snapshotVersion,N=C.withLastLimboFreeSnapshotVersion(V);m.Ss=m.Ss.insert(I,N)}}}(r.localStore,o))}async function $m(n,t){const e=F(n);if(!e.currentUser.isEqual(t)){O(pi,"User change. New user:",t.toKey());const r=await rl(e.localStore,t);e.currentUser=t,function(o,a){o.cu.forEach(c=>{c.forEach(h=>{h.reject(new k(b.CANCELLED,a))})}),o.cu.clear()}(e,"'waitForPendingWrites' promise is rejected due to a user change."),e.sharedClientState.handleUserChange(t,r.removedBatchIds,r.addedBatchIds),await On(e,r.Ms)}}function zm(n,t){const e=F(n),r=e._u.get(t);if(r&&r.tu)return j().add(r.key);{let s=j();const o=e.iu.get(t);if(!o)return s;for(const a of o){const c=e.ru.get(a);s=s.unionWith(c.view.Wa)}return s}}function wl(n){const t=F(n);return t.remoteStore.remoteSyncer.applyRemoteEvent=El.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=zm.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=Um.bind(null,t),t.nu.Q_=Cm.bind(null,t.eventManager),t.nu.Tu=Pm.bind(null,t.eventManager),t}function Gm(n){const t=F(n);return t.remoteStore.remoteSyncer.applySuccessfulWrite=Bm.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=qm.bind(null,t),t}class Cr{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=Fr(t.databaseInfo.databaseId),this.sharedClientState=this.Au(t),this.persistence=this.Ru(t),await this.persistence.start(),this.localStore=this.Vu(t),this.gcScheduler=this.mu(t,this.localStore),this.indexBackfillerScheduler=this.fu(t,this.localStore)}mu(t,e){return null}fu(t,e){return null}Vu(t){return Wf(this.persistence,new Hf,t.initialUser,this.serializer)}Ru(t){return new nl(ii.Ei,this.serializer)}Au(t){return new nm}async terminate(){var t,e;(t=this.gcScheduler)===null||t===void 0||t.stop(),(e=this.indexBackfillerScheduler)===null||e===void 0||e.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Cr.provider={build:()=>new Cr};class Hm extends Cr{constructor(t){super(),this.cacheSizeBytes=t}mu(t,e){K(this.persistence.referenceDelegate instanceof Rr,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new Df(r,t.asyncQueue,e)}Ru(t){const e=this.cacheSizeBytes!==void 0?bt.withCacheSize(this.cacheSizeBytes):bt.DEFAULT;return new nl(r=>Rr.Ei(r,e),this.serializer)}}class js{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>Na(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=$m.bind(null,this.syncEngine),await Am(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new bm}()}createDatastore(t){const e=Fr(t.databaseInfo.databaseId),r=function(o){return new am(o)}(t.databaseInfo);return function(o,a,c,h){return new hm(o,a,c,h)}(t.authCredentials,t.appCheckCredentials,r,e)}createRemoteStore(t){return function(r,s,o,a,c){return new fm(r,s,o,a,c)}(this.localStore,this.datastore,t.asyncQueue,e=>Na(this.syncEngine,e,0),function(){return ba.C()?new ba:new rm}())}createSyncEngine(t,e){return function(s,o,a,c,h,f,m){const y=new Nm(s,o,a,c,h,f);return m&&(y.hu=!0),y}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){var t,e;await async function(s){const o=F(s);O(Ee,"RemoteStore shutting down."),o.aa.add(5),await kn(o),o.ca.shutdown(),o.la.set("Unknown")}(this.remoteStore),(t=this.datastore)===null||t===void 0||t.terminate(),(e=this.eventManager)===null||e===void 0||e.terminate()}}js.provider={build:()=>new js};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Al{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.pu(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.pu(this.observer.error,t):Ht("Uncaught Error in snapshot listener:",t.toString()))}yu(){this.muted=!0}pu(t,e){setTimeout(()=>{this.muted||t(e)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function za(n){return function(e,r){if(typeof e!="object"||e===null)return!1;const s=e;for(const o of r)if(o in s&&typeof s[o]=="function")return!0;return!1}(n,["next","error","complete"])}class Vn extends jr{constructor(t,e,r,s){super(t,e,r,s),this.type="firestore",this._queue=new ja,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new ja(t),this._firestoreClient=void 0,await t}}}function tp(n,t){const e=typeof n=="object"?n:Gh(),r=typeof n=="string"?n:Er,s=Bh(e,"firestore").getImmediate({identifier:r});if(!s._initialized){const o=Vc("firestore");o&&Jm(s,...o)}return s}function _i(n){if(n._terminated)throw new k(b.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||ep(n),n._firestoreClient}function ep(n){var t,e,r;const s=n._freezeSettings(),o=function(c,h,f,m){return new wd(c,h,f,m.host,m.ssl,m.experimentalForceLongPolling,m.experimentalAutoDetectLongPolling,bl(m.experimentalLongPollingOptions),m.useFetchStreams,m.isUsingEmulator)}(n._databaseId,((t=n._app)===null||t===void 0?void 0:t.options.appId)||"",n._persistenceKey,s);n._componentsProvider||!((e=s.localCache)===null||e===void 0)&&e._offlineComponentProvider&&(!((r=s.localCache)===null||r===void 0)&&r._onlineComponentProvider)&&(n._componentsProvider={_offline:s.localCache._offlineComponentProvider,_online:s.localCache._onlineComponentProvider}),n._firestoreClient=new Km(n._authCredentials,n._appCheckCredentials,n._queue,o,n._componentsProvider&&function(c){const h=c==null?void 0:c._online.build();return{_offline:c==null?void 0:c._offline.build(h),_online:h}}(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ge{constructor(t){this._byteString=t}static fromBase64String(t){try{return new Ge(mt.fromBase64String(t))}catch(e){throw new k(b.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(t){return new Ge(mt.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const np=/^__.*__$/;class rp{constructor(t,e,r){this.data=t,this.fieldMask=e,this.fieldTransforms=r}toMutation(t,e){return this.fieldMask!==null?new we(t,this.data,this.fieldMask,e,this.fieldTransforms):new Dn(t,this.data,e,this.fieldTransforms)}}function Sl(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw M(40011,{oc:n})}}class Ii{constructor(t,e,r,s,o,a){this.settings=t,this.databaseId=e,this.serializer=r,this.ignoreUndefinedProperties=s,o===void 0&&this._c(),this.fieldTransforms=o||[],this.fieldMask=a||[]}get path(){return this.settings.path}get oc(){return this.settings.oc}ac(t){return new Ii(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}uc(t){var e;const r=(e=this.path)===null||e===void 0?void 0:e.child(t),s=this.ac({path:r,cc:!1});return s.lc(t),s}hc(t){var e;const r=(e=this.path)===null||e===void 0?void 0:e.child(t),s=this.ac({path:r,cc:!1});return s._c(),s}Pc(t){return this.ac({path:void 0,cc:!0})}Tc(t){return Pr(t,this.settings.methodName,this.settings.Ic||!1,this.path,this.settings.Ec)}contains(t){return this.fieldMask.find(e=>t.isPrefixOf(e))!==void 0||this.fieldTransforms.find(e=>t.isPrefixOf(e.field))!==void 0}_c(){if(this.path)for(let t=0;t<this.path.length;t++)this.lc(this.path.get(t))}lc(t){if(t.length===0)throw this.Tc("Document fields must not be empty");if(Sl(this.oc)&&np.test(t))throw this.Tc('Document fields cannot begin and end with "__"')}}class sp{constructor(t,e,r){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=r||Fr(t)}dc(t,e,r,s=!1){return new Ii({oc:t,methodName:e,Ec:r,path:ft.emptyPath(),cc:!1,Ic:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function wi(n){const t=n._freezeSettings(),e=Fr(n._databaseId);return new sp(n._databaseId,!!t.ignoreUndefinedProperties,e)}function ip(n,t,e,r,s,o={}){const a=n.dc(o.merge||o.mergeFields?2:0,t,e,s);kl("Data must be an object, but it was:",a,r);const c=Dl(r,a);let h,f;if(o.merge)h=new Ot(a.fieldMask),f=a.fieldTransforms;else if(o.mergeFields){const m=[];for(const y of o.mergeFields){const I=op(t,y,e);if(!a.contains(I))throw new k(b.INVALID_ARGUMENT,`Field '${I}' is specified in your field mask but missing from your input data.`);up(m,I)||m.push(I)}h=new Ot(m),f=a.fieldTransforms.filter(y=>h.covers(y.field))}else h=null,f=a.fieldTransforms;return new rp(new Dt(c),h,f)}class Ai extends Ei{_toFieldTransform(t){return new Wd(t.path,new Cn)}isEqual(t){return t instanceof Ai}}function Vl(n,t,e,r=!1){return Ri(e,n.dc(r?4:3,t))}function Ri(n,t){if(Nl(n=re(n)))return kl("Unsupported field value:",t,n),Dl(n,t);if(n instanceof Ei)return function(r,s){if(!Sl(s.oc))throw s.Tc(`${r._methodName}() can only be used with update() and set()`);if(!s.path)throw s.Tc(`${r._methodName}() is not currently supported inside arrays`);const o=r._toFieldTransform(s);o&&s.fieldTransforms.push(o)}(n,t),null;if(n===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),n instanceof Array){if(t.settings.cc&&t.oc!==4)throw t.Tc("Nested arrays are not supported");return function(r,s){const o=[];let a=0;for(const c of r){let h=Ri(c,s.Pc(a));h==null&&(h={nullValue:"NULL_VALUE"}),o.push(h),a++}return{arrayValue:{values:o}}}(n,t)}return function(r,s){if((r=re(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return Hd(s.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const o=ut.fromDate(r);return{timestampValue:Ar(s.serializer,o)}}if(r instanceof ut){const o=new ut(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:Ar(s.serializer,o)}}if(r instanceof vi)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof Ge)return{bytesValue:Qu(s.serializer,r._byteString)};if(r instanceof St){const o=s.databaseId,a=r.firestore._databaseId;if(!a.isEqual(o))throw s.Tc(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${o.projectId}/${o.database}`);return{referenceValue:ri(r.firestore._databaseId||s.databaseId,r._key.path)}}if(r instanceof Ti)return function(a,c){return{mapValue:{fields:{[wu]:{stringValue:Au},[vr]:{arrayValue:{values:a.toArray().map(f=>{if(typeof f!="number")throw c.Tc("VectorValues must only contain numeric values.");return ti(c.serializer,f)})}}}}}}(r,s);throw s.Tc(`Unsupported field value: ${qr(r)}`)}(n,t)}function Dl(n,t){const e={};return _u(n)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):ve(n,(r,s)=>{const o=Ri(s,t.uc(r));o!=null&&(e[r]=o)}),{mapValue:{fields:e}}}function Nl(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof ut||n instanceof vi||n instanceof Ge||n instanceof St||n instanceof Ei||n instanceof Ti)}function kl(n,t,e){if(!Nl(e)||!function(s){return typeof s=="object"&&s!==null&&(Object.getPrototypeOf(s)===Object.prototype||Object.getPrototypeOf(s)===null)}(e)){const r=qr(e);throw r==="an object"?t.Tc(n+" a custom object"):t.Tc(n+" "+r)}}function op(n,t,e){if((t=re(t))instanceof yi)return t._internalPath;if(typeof t=="string")return Ol(n,t);throw Pr("Field path arguments must be of type string or ",n,!1,void 0,e)}const ap=new RegExp("[~\\*/\\[\\]]");function Ol(n,t,e){if(t.search(ap)>=0)throw Pr(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,e);try{return new yi(...t.split("."))._internalPath}catch{throw Pr(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,e)}}function Pr(n,t,e,r,s){const o=r&&!r.isEmpty(),a=s!==void 0;let c=`Function ${t}() called with invalid data`;e&&(c+=" (via `toFirestore()`)"),c+=". ";let h="";return(o||a)&&(h+=" (found",o&&(h+=` in field ${r}`),a&&(h+=` in document ${s}`),h+=")"),new k(b.INVALID_ARGUMENT,c+n+h)}function up(n,t){return n.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pn{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Ll extends bi{constructor(t,e,r,s,o,a){super(t,e,r,s,a),this._firestore=t,this._firestoreImpl=t,this.metadata=o}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new fr(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const r=this._document.data.field(Ci("DocumentSnapshot.get",t));if(r!==null)return this._userDataWriter.convertValue(r,e.serverTimestamps)}}}class fr extends Ll{data(t={}){return super.data(t)}}class Fl{constructor(t,e,r,s){this._firestore=t,this._userDataWriter=e,this._snapshot=s,this.metadata=new pn(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(r=>{t.call(e,new fr(this._firestore,this._userDataWriter,r.key,r,new pn(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new k(b.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(s,o){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(c=>{const h=new fr(s._firestore,s._userDataWriter,c.doc.key,c.doc,new pn(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);return c.doc,{type:"added",doc:h,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(c=>o||c.type!==3).map(c=>{const h=new fr(s._firestore,s._userDataWriter,c.doc.key,c.doc,new pn(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);let f=-1,m=-1;return c.type!==0&&(f=a.indexOf(c.doc.key),a=a.delete(c.doc.key)),c.type!==1&&(a=a.add(c.doc),m=a.indexOf(c.doc.key)),{type:fp(c.type),doc:h,oldIndex:f,newIndex:m}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function fp(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return M(61501,{type:n})}}class Oi extends hp{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ge(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new St(this.firestore,null,e)}}function Ts(n){n=_e(n,Bt);const t=_e(n.firestore,Vn),e=_i(t),r=new Oi(t);return xl(n._query),Ym(e,n._query).then(s=>new Fl(t,r,n,s))}function or(n,t){const e=_e(n.firestore,Vn),r=Zm(n),s=dp(n.converter,t);return pp(e,[ip(wi(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,zt.exists(!1))]).then(()=>r)}function mp(n,...t){var e,r,s;n=re(n);let o={includeMetadataChanges:!1,source:"default"},a=0;typeof t[a]!="object"||za(t[a])||(o=t[a],a++);const c={includeMetadataChanges:o.includeMetadataChanges,source:o.source};if(za(t[a])){const y=t[a];t[a]=(e=y.next)===null||e===void 0?void 0:e.bind(y),t[a+1]=(r=y.error)===null||r===void 0?void 0:r.bind(y),t[a+2]=(s=y.complete)===null||s===void 0?void 0:s.bind(y)}let h,f,m;if(n instanceof St)f=_e(n.firestore,Vn),m=Js(n._key.path),h={next:y=>{t[a]&&t[a](gp(f,n,y))},error:t[a+1],complete:t[a+2]};else{const y=_e(n,Bt);f=_e(y.firestore,Vn),m=y._query;const I=new Oi(f);h={next:C=>{t[a]&&t[a](new Fl(f,I,y,C))},error:t[a+1],complete:t[a+2]},xl(n._query)}return function(I,C,V,N){const S=new Al(N),B=new pl(C,S,V);return I.asyncQueue.enqueueAndForget(async()=>fl(await $s(I),B)),()=>{S.yu(),I.asyncQueue.enqueueAndForget(async()=>ml(await $s(I),B))}}(_i(f),m,c,h)}function pp(n,t){return function(r,s){const o=new ee;return r.asyncQueue.enqueueAndForget(async()=>Fm(await Wm(r),s,o)),o.promise}(_i(n),t)}function gp(n,t,e){const r=e.docs.get(t._key),s=new Oi(n);return new Ll(n,s,t._key,r,new pn(e.hasPendingWrites,e.fromCache),t.converter)}function ar(){return new Ai("serverTimestamp")}(function(t,e=!0){(function(s){Ke=s})(zh),_r(new vn("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),c=new Vn(new od(r.getProvider("auth-internal")),new ld(a,r.getProvider("app-check-internal")),function(f,m){if(!Object.prototype.hasOwnProperty.apply(f.options,["projectId"]))throw new k(b.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new An(f.options.projectId,m)}(a,s),a);return o=Object.assign({useFetchStreams:e},o),c._setSettings(o),c},"PUBLIC").setMultipleInstances(!0)),xe(Ko,Qo,t),xe(Ko,Qo,"esm2017")})();const _p={apiKey:"AIzaSyC-witEf8tEuC5ZGOTlvX00QletwcVMl6g",authDomain:"phils-corner.firebaseapp.com",projectId:"phils-corner",storageBucket:"phils-corner.firebasestorage.app",messagingSenderId:"211606223114",appId:"1:211606223114:web:8b63fb9e90fc4eaab662f3"},yp=ru(_p),Qa=tp(yp);document.addEventListener("DOMContentLoaded",()=>{const n=new Audio("/sounds/aim-send.wav"),t=new Audio("/sounds/aim-receive.wav"),e=new Audio("/sounds/signon.mp3"),r=document.getElementById("aim-start"),s=document.getElementById("aim-username"),o=document.getElementById("aim-login"),a=document.getElementById("aim-chat-area"),c=Ba(Qa,"aim_chat"),h=document.getElementById("chat-form"),f=document.getElementById("chat-input"),m=document.getElementById("chat-box");let y="",I="",C=new Set,V=null;r==null||r.addEventListener("click",async()=>{const st=s.value.trim();if(!st)return;y=st,I=crypto.randomUUID(),o.style.display="none",a.style.display="block",e.play();const Rt=Se(c,Ve("timestamp"));V=mp(Rt,at=>{at.docChanges().forEach(et=>{if(et.type==="added"){const Z=et.doc.data();if(Z.sessionId!==I)return;const Vt=document.createElement("div");Vt.className=Z.sender===y?"chat-you":"chat-bot",Vt.textContent=`${Z.sender}: ${Z.message}`,m.appendChild(Vt),m.scrollTop=m.scrollHeight,Z.sender!==y&&!C.has(et.doc.id)&&t.play()}})}),setTimeout(async()=>{const at=await or(c,{sender:"SmarterChild",message:`Hey ${y}! I'm SmarterChild. What do you want to talk about?`,timestamp:ar(),sessionId:I});C.add(at.id)},1500)}),h==null||h.addEventListener("submit",async st=>{st.preventDefault();const Rt=f.value.trim();if(!Rt||!y)return;n.play();const at=await or(c,{sender:y,message:Rt,timestamp:ar(),sessionId:I});C.add(at.id),f.value="",setTimeout(async()=>{const et=Ep(Rt),Z=await or(c,{sender:"SmarterChild",message:et,timestamp:ar(),sessionId:I});C.add(Z.id)},800+Math.random()*1e3)}),window.addEventListener("beforeunload",()=>{V&&V()});const N=3,S=Ba(Qa,"guestbook"),B=document.getElementById("guestbook-form"),U=document.getElementById("guestbook-name"),$=document.getElementById("guestbook-emotion"),X=document.getElementById("guestbook-entry"),Ct=document.getElementById("guestbook-messages"),J=document.getElementById("pagination"),v=document.getElementById("prev-page"),p=document.getElementById("next-page");let g=0,E=1,T=[];const A=J&&v&&p;J&&(J.style.display="none",J.style.justifyContent="space-between"),v&&(v.style.display="none");async function _(){if(!A)return;const st=Se(S,Ve("timestamp","desc")),at=(await Ts(st)).size;E=Math.max(1,Math.ceil(at/N)),J.style.display=at>N?"flex":"none",T=[];let et=null;for(let Z=0;Z<E;Z++){let Vt;Z===0?Vt=Se(S,Ve("timestamp","desc"),ir(N)):Vt=Se(S,Ve("timestamp","desc"),Ga(et),ir(N));const qt=await Ts(Vt);qt.empty||(T.push(qt.docs[0]),et=qt.docs[qt.docs.length-1])}}async function At(st){if(!A||st<0||st>=E)return;g=st;let Rt;if(st===0)Rt=Se(S,Ve("timestamp","desc"),ir(N));else{const et=T[st];if(!et)return;Rt=Se(S,Ve("timestamp","desc"),Ga(et),ir(N))}const at=await Ts(Rt);Ct&&(Ct.innerHTML="",at.empty||at.forEach(et=>{var Nt;const Z=et.data(),Vt=((Nt=Z.timestamp)==null?void 0:Nt.toDate().toLocaleString())||"(no time)",qt=document.createElement("div");qt.innerHTML=`
          <p><strong>${Z.name||"Anonymous"}</strong> (${Z.emotion||"feeling...?"}) at ${Vt}:</p>
          <p>${Z.message}</p>
          <hr>
        `,Ct.appendChild(qt)}),v&&(v.disabled=g===0,v.style.display=g===0?"none":"inline-block"),p&&(p.disabled=g>=E-1))}B==null||B.addEventListener("submit",async st=>{st.preventDefault();const Rt=U.value.trim(),at=$.value,et=X.value.trim();if(et)try{await or(S,{name:Rt,emotion:at,message:et,timestamp:ar()}),U.value="",$.value="",X.value="",await _(),await At(0)}catch(Z){console.error("Error adding message:",Z),alert("Failed to add your message: "+Z.message)}}),v&&v.addEventListener("click",()=>{g>0&&At(g-1)}),p&&p.addEventListener("click",()=>{g<E-1&&At(g+1)}),_().then(()=>At(0))});function Ep(n){const t=n.toLowerCase(),e=["hey","hi","hello","yo","sup"],r=["?","what","why","how","who","when","where"],s=["sad","tired","bored","lonely"],o=["happy","excited","yay","awesome"],a=["love","crush","date","boyfriend","girlfriend"];return["bye","goodbye","see ya","later","ttyl","cya","farewell"].some(h=>t.includes(h))?me(Ec):e.some(h=>t.includes(h))?me(["yo yo yo!","what’s crackin’?","hey hey!","sup dawg?","how YOU doin’?"]):r.some(h=>t.includes(h))?me(["hmm good question...","I was just thinking about that!","no clue, dude","you tell me 😏","maybe ask Jeeves?"]):s.some(h=>t.includes(h))?me(["bummer 😢","same here","want me to play a sad playlist?","*virtual hug*","feelin' those 00s vibes"]):o.some(h=>t.includes(h))?me(["awesome!","totally rad 😄","party time!","let’s celebrate!","high five!"]):a.some(h=>t.includes(h))?me(["aww, cute 💖","you crushing hard?","omg tell me everything","heart eyes 😍","classic 00s romance!"]):me(yc)}function me(n){return n[Math.floor(Math.random()*n.length)]}
